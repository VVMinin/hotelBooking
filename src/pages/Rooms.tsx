...
const Rooms: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (currentRooms.length === 0) {
      const defaultRooms = [
        {
          id: '1', name: 'Уютный Стандарт', price: 2500, roomCount: 1, description: 'Классический однокомнатный номер с двуспальной кроватью. Идеально подходит для коротких поездок.',
        ...
        {
          id: '2', name: 'Просторный Стандарт', price: 2800, roomCount: 1, description: 'Улучшенный однокомнатный номер с большой рабочей зоной и видом на тихий внутренний двор.',
        ...
        {
          id: '3', name: 'Семейный Люкс', price: 5500, roomCount: 2, description: 'Двухкомнатный люкс с отдельной гостиной и спальней. Прекрасный выбор для семейного отдыха.',
        ...
        {
          id: '4', name: 'Делюкс с балконом', price: 4200, roomCount: 1, description: 'Элегантный номер с панорамными окнами и собственным балконом с видом на парк.',
        ...
        {
          id: '5', name: 'Номер "Комфорт"', price: 3100, roomCount: 1, description: 'Однокомнатный номер повышенной комфортности с ортопедическим матрасом и выбором подушек.',
        ...
        {
          id: '6', name: 'Президентский Пентхаус', price: 12000, roomCount: 3, description: 'Роскошный трехкомнатный пентхаус на последнем этаже с террасой и панорамным видом на город.',
        ...
        {
          id: '7', name: 'Студия', price: 3500, roomCount: 1, description: 'Просторный номер-студия с кухонной зоной и всем необходимым для длительного проживания.',
        ...
        {
          id: '8', name: 'Номер для новобрачных', price: 6500, roomCount: 2, description: 'Романтический двухкомнатный номер с джакузи и специальным обслуживанием для молодоженов.',
        ...
        {
          id: '11', name: 'Стандартный Улучшенный', price: 2900, roomCount: 1, description: 'Просторный номер с дополнительной зоной отдыха и современным дизайном.',
        ...
        {
          id: '13', name: 'Стандартный Семейный', price: 3200, roomCount: 1, description: 'Номер с возможностью размещения до 4-х человек. Идеально для небольших семей.',
        ...
        {
          id: '14', name: 'Стандартный Комфорт+', price: 3300, roomCount: 1, description: 'Номер с расширенным набором удобств и улучшенной звукоизоляцией.',
        ...
        {
          id: '16', name: 'Люкс "Арт-деко"', price: 6800, roomCount: 2, description: 'Изысканный люкс, оформленный в стиле арт-деко, с уникальной мебелью и произведениями искусства.',
